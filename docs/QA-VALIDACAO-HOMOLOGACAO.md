...
Antes de qualquer teste, executar no Supabase homolog (SQL Editor):

- [ ] `web/supabase/schema.sql` — schema base
- [ ] `web/supabase/migrations/001_mvp_v2.sql` — Fase 1
- [ ] `web/supabase/migrations/002_fase2_financas.sql` — Fase 2
- [ ] `web/supabase/migrations/003_fase3_metas.sql` — Fase 3
- [ ] `web/supabase/seeds/001_seed_homolog.sql` — dados de teste
