      ...
      <div className="flex items-center">
        ...
        <div className="flex-1 py-7 px-8">
          <div className="flex items-center gap-[10px] mb-[10px]">
            <span className="px-[10px] py-1 rounded-lg text-[10px] font-bold uppercase tracking-[.06em] bg-[rgba(199,103,149,.1)] text-[#C76795]">
              Proxima Viagem
            </span>
          </div>
            ...
            <div>
              ...
              <div className="w-full h-1.5 bg-[var(--sl-s3)] rounded-[3px] overflow-hidden">
                <div
                  ...
                  style={{ width: `${pct}%`, background: 'linear-gradient(90deg, #C76795, #a855f7)' }}
                />
              </div>
            </div>
        ...
        <div className="flex flex-col gap-2 py-7 px-8 border-l border-[var(--sl-border)]">
          <button
            ...
            className="flex items-center gap-[7px] px-[22px] py-[9px] rounded-[11px] text-[12px] font-semibold bg-[#C76795] text-white w-full hover:brightness-110 hover:-translate-y-px transition-all"
          >
