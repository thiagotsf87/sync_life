              ...
              <div className="flex flex-col items-center">
                {step.status === 'done' ? (
                  ...
                  <div
                    ...
                    style={{ background: '#8B7BD4', boxShadow: '0 0 14px rgba(139,123,212,0.45)' }}
                  >
                    <div className="w-[10px] h-[10px] rounded-full bg-white" />
                  </div>
                ) : step.status === 'vision' ? (
                  <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 border-[1.5px] border-dashed border-[rgba(217,150,46,0.4)]"
                    style={{ background: 'linear-gradient(135deg, rgba(217,150,46,0.15), rgba(199,103,149,0.1))' }}>
                ...
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  ...
                  {step.status === 'current' && (
                    <span className="inline-flex px-2 py-[3px] rounded-[10px] text-[10px] font-semibold"
                      style={{ background: 'rgba(139,123,212,0.12)', color: '#c4b5fd' }}>
                      ✦ Agora
                    </span>
                  )}
                </div>
