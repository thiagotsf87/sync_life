  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(160deg, rgba(139,123,212,0.12), rgba(199,103,149,0.06))',
          borderColor: border,
        }}
      >
        <div className="flex gap-[14px] items-start mb-[14px]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[13px] text-[#C76795] mt-[2px]">
        ...
        <div className="pt-3 border-t" style={{ borderColor: 'rgba(139,123,212,0.15)' }}>
