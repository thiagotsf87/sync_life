    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4"
      ...
      <div className="bg-[var(--sl-s1)] border rounded-2xl w-full max-w-[440px]"
        ...
        <div className="p-5 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="text" value={targetTitle} onChange={e => setTargetTitle(e.target.value)}
                ...
                className="w-full px-3 py-2.5 rounded-[10px] text-[13px] bg-[var(--sl-s2)] border border-[var(--sl-border)] text-[var(--sl-t1)] placeholder:text-[var(--sl-t3)] outline-none focus:border-[#8B7BD4]" />
            </div>
          </div>
            ...
            <div className="flex gap-2">
              {['6', '12', '18', '24'].map(m => (
                <button key={m} onClick={() => setMonths(m)}
                  ...
                  style={months === m ? {
                    borderColor: '#8B7BD4', background: 'rgba(139,123,212,0.15)', color: '#c4b5fd'
                  } : {
          ...
          {target > curr && curr > 0 && (
            <div className="rounded-xl p-4 border" style={{ background: 'linear-gradient(135deg, rgba(139,123,212,0.1), rgba(199,103,149,0.06))', borderColor: 'rgba(139,123,212,0.2)' }}>
