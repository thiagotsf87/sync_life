  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ background: `linear-gradient(135deg, ${bg}, rgba(199,103,149,0.06))`, borderColor: border }}
      >
        <div className="flex gap-[14px] items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-[6px] mt-[6px] flex-wrap">
              <span className="inline-flex items-center gap-[3px] px-2 py-[3px] rounded-[10px] text-[10px] font-semibold bg-[rgba(139,123,212,0.12)] text-[#c4b5fd]">
                ⚡ +480 XP acumulados
              </span>
              <span className="inline-flex items-center gap-[3px] px-2 py-[3px] rounded-[10px] text-[10px] font-semibold bg-[rgba(199,103,149,0.12)] text-[#f472b6]">
                Sênior em vista
              </span>
            </div>
          </div>
      ...
      <div
        className="mx-4 mb-3 rounded-2xl p-4 border"
        style={{ background: `rgba(199,103,149,0.07)`, borderColor: 'rgba(199,103,149,0.2)' }}
      >
        <div className="flex justify-between items-center mb-[10px]">
          ...
          <span className="inline-flex px-2 py-[3px] rounded-[10px] text-[10px] font-semibold bg-[rgba(199,103,149,0.12)] text-[#f472b6]">
            {roadmapPct}%
          </span>
        </div>
        ...
        <div className="flex gap-[6px] flex-wrap">
          ...
          {inProgressSteps.slice(0, 1).map(s => (
            <span key={s.id} className="text-[11px] px-2 py-[3px] rounded-lg bg-[rgba(199,103,149,0.1)]" style={{ color: accent }}>
              ⟳ {s.title}
            </span>
          ))}
