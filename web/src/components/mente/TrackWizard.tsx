            ...
            <div key={i} className="flex items-center gap-1.5 flex-1">
              <div className="flex flex-col items-center gap-1 flex-1">
                <div
                  ...
                  style={{ background: i <= step ? 'var(--sl-em)' : 'var(--sl-s3)' }}
                />
                <span className={cn(
                  'text-[9px] font-bold uppercase tracking-wider transition-colors',
                  i <= step ? 'text-[var(--sl-em)]' : 'text-[var(--sl-t3)]'
                )}>
                  {label}
                </span>
              </div>
        ...
        <div className="px-5 py-3 flex flex-col gap-3 max-h-[60vh] overflow-y-auto">
          ...
          {step === 0 && (
            <>
              ...
              <div>
                <label className="text-[11px] font-bold uppercase tracking-[0.14em] text-[var(--sl-t3)] mb-1.5 block">
                  Categoria
                </label>
          ...
          {step === 1 && (
            <>
              ...
              <div className="flex gap-2 items-end">
                ...
                <button
                  onClick={addStep}
                  className="px-3 py-2.5 rounded-[10px] text-white hover:opacity-90 transition-opacity"
          ...
          {step === 2 && (
            <>
              ...
              {skills.length > 0 && (
                <div>
                  <SelectField
                    label="HABILIDADE VINCULADA (CARREIRA)"
                    ...
                    hint="Ao concluir a trilha, você será lembrado de atualizar o nível."
                  />
                </div>
              )}
              ...
              {objectives.length > 0 && (
                <div>
                  <SelectField
                    label="OBJETIVO VINCULADO (FUTURO)"
                    ...
                    hint="Ao marcar etapas, o progresso da meta no Futuro será sincronizado."
                  />
                </div>
              )}
              ...
              {form.cost && parseFloat(form.cost) > 0 && (
                <label className="flex items-center gap-2 cursor-pointer select-none py-1">
                  <input
                    ...
                    className="accent-[var(--sl-em)] w-3.5 h-3.5"
                  />
              ...
              <label className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-3.5 py-2.5 rounded-[10px] text-[14px] resize-none
              ...
              {/* Preview */}
              <div className="bg-[var(--sl-s2)] border border-[var(--sl-border-em)] rounded-xl p-3">
                <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--sl-em)] mb-1.5">Resumo</p>
