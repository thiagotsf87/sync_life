...
export function MobileHeader({ userName }: MobileHeaderProps) {
  ...
  // Subtítulo: nome da subpágina quando diferente do label do módulo
  ...
  return (
    <header className="sticky top-0 z-40 bg-[var(--sl-s1)] border-b border-[var(--sl-border)] shrink-0 lg:hidden">
      ...
      {/* ── Linha 2: Jornada only — saudação + pills Foco/Jornada ── */}
      {isJornada && (
        <div className="flex items-center justify-between px-4 pb-2.5 pt-0.5 gap-3">
