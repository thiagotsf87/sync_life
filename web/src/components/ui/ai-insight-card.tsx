...
export function AIInsightCard({
  ...
  return (
    ...
    >
      <div className="flex h-[32px] w-[32px] shrink-0 items-center justify-center rounded-[10px] bg-[rgba(107,111,212,0.15)] text-[16px]">
        {icon}
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-[11px] font-bold uppercase tracking-[0.5px] text-[#6B6FD4] mb-1">
          {label}
        </p>
