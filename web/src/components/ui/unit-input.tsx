  ...
  return (
    ...
    >
      <input
        ...
        className="w-full bg-transparent pl-3 pr-[44px] py-2.5 text-[14px] font-[IBM_Plex_Mono] text-[var(--sl-t1)] outline-none placeholder:text-[var(--sl-t3)]/50 [appearance:textfield]"
      />
