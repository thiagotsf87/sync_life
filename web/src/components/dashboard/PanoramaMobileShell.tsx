    ...
    <div className="lg:hidden">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? 'text-[#6B6FD4] font-semibold border-b-[#6B6FD4]'
      ...
      {title && (
        <div className="px-5 pt-[14px] pb-3">
          <h1 className="font-[Syne] text-[20px] font-bold tracking-tight text-[var(--sl-t1)]">
            {title}
          </h1>
          {subtitle && (
            <p className="font-[DM_Sans] text-[12px] text-[var(--sl-t2)] mt-0.5">{subtitle}</p>
          )}
        </div>
      )}
