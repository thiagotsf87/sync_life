  ...
  return (
    <div className="bg-[var(--sl-s1)] border border-[var(--sl-border)] rounded-[14px] p-[18px] sl-fade-up sl-delay-1 hover:border-[var(--sl-border-h)] transition-colors">
      <div className="flex items-center gap-2 mb-[14px]">
        <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: 'rgba(107,111,212,.1)' }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B6FD4" strokeWidth="2" strokeLinecap="round">
      ...
      <div className="text-center py-2.5">
        <div className="font-[IBM_Plex_Mono] font-medium text-[28px]" style={{ color: '#0F766E' }}>{fmt(projectedBalance)}</div>
