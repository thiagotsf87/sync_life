                  ...
                  <div className="w-full h-[10px] bg-[var(--sl-s2)] rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        background: m.rate >= goalRate ? '#0F766E' : m.rate >= goalRate * 0.75 ? '#D9962E' : '#DB6478',
                      }}
                    />
                  </div>
                  <div
                    className="absolute top-[-4px] bottom-[-4px] w-0.5 bg-[rgba(219,100,120,0.7)] rounded-[1px] z-[2] pointer-events-none"
