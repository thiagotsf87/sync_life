        ...
        <div className="flex flex-col gap-1">
          {topExpenses.map((txn, i) => (
            <div
              ...
              <span className="font-[IBM_Plex_Mono] text-[10px] text-[var(--sl-t3)] w-3.5 text-center shrink-0">{i + 1}</span>
              ...
              <span className="font-[IBM_Plex_Mono] text-[13px] text-[#DB6478] shrink-0">{fmtR(txn.amount)}</span>
