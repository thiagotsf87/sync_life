  ...
  return (
    <div className="mx-4 mb-2 bg-[var(--sl-s1)] border border-[var(--sl-border)] rounded-[16px] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-[14px] py-[11px] border-b border-[var(--sl-border)]">
        <span className="font-[Space_Grotesk] text-[13px] font-bold text-[var(--sl-t1)]">{month}</span>
        <span className="font-[IBM_Plex_Mono] text-[14px] font-medium" style={{ color: totalColor }}>
          {total}
        </span>
      </div>
      ...
      {entries.map((entry, i) => (
        ...
        >
          ...
          <span
            className="font-[IBM_Plex_Mono] text-[12px] font-medium shrink-0"
