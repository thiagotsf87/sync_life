...
export const MODULES: Record<ModuleId, ModuleConfig> = {
  ...
  corpo: {
    ...
    navItems: [
      ...
      { id: 'corpo-peso', label: 'Evolução', icon: 'Scale', href: '/corpo/peso' },
      { id: 'corpo-saude', label: 'Consultas', icon: 'HeartPulse', href: '/corpo/saude' },
      { id: 'corpo-atividades', label: 'Atividades', icon: 'Dumbbell', href: '/corpo/atividades' },
      { id: 'corpo-cardapio', label: 'Nutrição', icon: 'Utensils', href: '/corpo/cardapio' },
  ...
  carreira: {
    ...
    navItems: [
      ...
      { id: 'car-perfil', label: 'Perfil', icon: 'UserCheck', href: '/carreira/perfil' },
